...
# @file    dayuan.grid.sumoActuatedTL.runMe.py
# @author  Dayuan Tan
# @date    2020 05 25
# @version $Id$
...
if 'SUMO_HOME' in os.environ:
    ...
    # dayuanSUMOpath = os.path.join("/usr","local","Cellar","sumo","1.9.1","share","sumo","tools")
...
def run():
    ...
    #while traci.simulation.getTime() <360:#3600s
...
def calAvgWaitTime(tripinfo_output_filename):
    ...
    print("tripinfo_output_filename: ", tripinfo_output_filename)
...
if __name__ == "__main__":
    ...
    tripinfo_output_filename = "output/tripinfo.grid.ATL.vTypeDist.simpla" +dt_string+".xml"
    emission_output_filename = "output/emission.ATL." +dt_string+".xml"
    traci.start([sumoBinary, "-c", "sumocfg_dayuan.grid.ATL.vTypeDist.simpla.sumocfg",
